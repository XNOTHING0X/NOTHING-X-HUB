...
local function destroyGUI()
	...
	local guisToDestroy = {
		...
		gameGui and gameGui:FindFirstChild("DailyRewards"),
		gameGui and gameGui:FindFirstChild("EmoteWheel"),
		gameGui and gameGui:FindFirstChild("Transition"),
		gameGui and gameGui:FindFirstChild("KeyHints")
	}
